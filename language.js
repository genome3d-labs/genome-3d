(() => {
  const translations = {
    "pt": {
      topNote: "Projeto experimental de visualização genética",
      navAbout: "Sobre o Genome",
      navResources: "Recursos",
      navDownload: "Downloads",
      sideOverview: "Visão geral",
      sideResources: "Recursos atuais",
      sideDownload: "Download",
      sideCorporation: "Sobre a corporação",
      ...
      cytosine: "Citosina",
      guanine: "Guanina",
      downloadText: "A área está preparada para receber o instalador oficial do Genome. O botão de download será ativado quando o arquivo final de distribuição estiver publicado.",
      downloadSoon: "Download em breve",
      ...
      importantText: "o Genome 3D está em fase experimental e educacional. Ele não substitui ferramentas científicas validadas, análises laboratoriais ou softwares especializados de bioinformática.",
      quickAccess: "Acesso rápido",
      genomeDownload: "Download do Genome",
      loginArea: "Área de login",
      versionLabel: "Versão",
      previewTitle: "Prévia",
      previewOpenTitle: "Clique para abrir a imagem completa",
      previewAlt: "Prévia da interface do Genome 3D",
      previewCaption: "Interface atual do Genome 3D",
      viewFullImage: "Ver imagem completa",
      footerProject: "Genome 3D — projeto experimental",
      contactUs: "Contate-nos",

      backToSite: "Voltar ao site",
      homeBack: "← Página inicial",
      profileAlt: "Ícone de perfil",
      userEmail: "E-mail ou usuário",
      userPlaceholder: "Digite seu e-mail ou usuário",
      password: "Senha",
      passwordPlaceholder: "Digite sua senha",
      rememberComputer: "Lembrar neste computador",
      forgotPassword: "Esqueci minha senha",
      enter: "Entrar",
      authNotConnected: "O sistema de autenticação ainda não está conectado a um servidor.",
      accessArea: "Área de acesso",
      backToGenome: "Voltar ao Genome 3D",

      toggleText: "English",
      toggleTitle: "Mudar para inglês",
    ...
    "en": {
      ...
      navAbout: "About Genome",
      navResources: "Resources",
      navDownload: "Downloads",
      sideOverview: "Overview",
      sideResources: "Current resources",
      sideDownload: "Download",
      sideCorporation: "About the corporation",
      ...
      cytosine: "Cytosine",
      guanine: "Guanine",
      downloadText: "This area is prepared to receive the official Genome installer. The download button will be enabled when the final distribution file is published.",
      ...
      importantText: "Genome 3D is currently an experimental and educational project. It does not replace validated scientific tools, laboratory analyses, or specialized bioinformatics software.",
      quickAccess: "Quick access",
      genomeDownload: "Genome download",
      loginArea: "Login area",
      versionLabel: "Version",
      previewTitle: "Preview",
      previewOpenTitle: "Click to open the full image",
      previewAlt: "Preview of the Genome 3D interface",
      previewCaption: "Current Genome 3D interface",
      viewFullImage: "View full image",
      footerProject: "Genome 3D — experimental project",
      contactUs: "Contact us",

      backToSite: "Back to website",
      homeBack: "← Home",
      profileAlt: "Profile icon",
      userEmail: "Email or username",
      userPlaceholder: "Enter your email or username",
      password: "Password",
      passwordPlaceholder: "Enter your password",
      rememberComputer: "Remember on this computer",
      forgotPassword: "Forgot my password",
      enter: "Sign in",
      authNotConnected: "The authentication system is not connected to a server yet.",
      accessArea: "Access area",
      backToGenome: "Back to Genome 3D",

      toggleText: "Português",
      toggleTitle: "Switch to Portuguese",
